...
open class DeluxeSpeedView @JvmOverloads constructor(
    ...
    private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
        ...
        speedBackgroundPaint.color = a.getColor(
            R.styleable.DeluxeSpeedView_sv_speedBackgroundColor,
            speedBackgroundPaint.color
        )
        withEffects = a.getBoolean(R.styleable.DeluxeSpeedView_sv_withEffects, withEffects)
        circlePaint.color =
            a.getColor(R.styleable.DeluxeSpeedView_sv_centerCircleColor, circlePaint.color)
        centerCircleRadius =
            a.getDimension(R.styleable.DeluxeSpeedView_sv_centerCircleRadius, centerCircleRadius)
